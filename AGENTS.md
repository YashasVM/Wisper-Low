...
See [README.md](README.md) for the supported development commands.

## Architecture Overview

Wisperlow is a cross-platform speech-to-text application built with Tauri 2.x (Rust backend + React/TypeScript frontend).
...
Translation files live under `src/i18n/locales/`; English is the source locale.
...
Wisperlow supports command-line parameters on all platforms for integration with scripts, window managers, and autostart configurations.
