; Custom NSIS template for Wisperlow with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\\Wisperlow for portable
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Wisperlow Portable Mode"
    FileClose $0
